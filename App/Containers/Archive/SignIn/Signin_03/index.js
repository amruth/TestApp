...
export default class Signin_03 extends Component {
  ...
  render(){
		...
		let BG_Image = { uri : 'https://antiqueruby.aliansoftware.net/Images/signin/signin_header_bg_sthree.png' };
    let Profile_Image = { uri : "https://antiqueruby.aliansoftware.net/Images/signin/profile_image_sthree.png" };
      ...
      <Container>
        ...
        <Content style={styles.content}>
          <Form style={styles.form}>
            <Item>
              <Input keyboardType="email-address" placeholder='Email' textAlign={I18nManager.isRTL ? 'right' : 'left'} placeholderTextColor='#b7b7b7' style={styles.input1}  />
            </Item>
            <Item>
        ...
        <Footer >
          <View style={styles.btnSec}>
            <Text autoCapitalize="words" style={styles.buttontext}>Sign In</Text>
          </View>
        </Footer>
      </Container>
    );
