        ...
        <ImageBackground source={pic} style={styles.screenBg}>
            ...
            <View style={styles.modelMain}>
              <View style={styles.modelCenter}>
                ...
                <Item regular style={styles.item}>
                  <Input placeholder='Email' keyboardType="email-address" style={styles.input} />
                </Item>
                ...
                <View style={styles.rememView}>
                  <CheckBox checked={this.state.checked}  color={'#4cd964'} onPress={()=>this.setState({checked:!this.state.checked})} />
                  <Text style={styles.remem}>Remember me</Text>
                  <Text style={styles.forgot}>Forgot password?</Text>
                </View>
                <TouchableHighlight info style={styles.buttondialogsignup} onPress={() => { }}>
                  <Text autoCapitalize="words" style={styles.modelSignUp}>Sign Up</Text>
                </TouchableHighlight>
              </View>
            </View>
          </Modal>
          ...
          <Container style={styles.container}>
            ...
            <Form style={styles.form}>
              <TouchableHighlight  info style={styles.buttonlogin} onPress={() => { this.setModalVisible(true) }}>
                <Text autoCapitalize="words" style={styles.btnText}>Login</Text>
              </TouchableHighlight>
              <TouchableHighlight  info style={styles.buttonsignup} onPress={() => { }}>
                <Text autoCapitalize="words" style={styles.btnText}>Sign Up</Text>
              </TouchableHighlight>
            </Form>
