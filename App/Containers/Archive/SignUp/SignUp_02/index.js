...
import { Text, View, Image,TextInput,Platform,StatusBar,TouchableOpacity,ImageBackground,ScrollView ,BackHandler,I18nManager} from 'react-native';
				...
				<Container style={styles.container}>
					...
					<ScrollView>
						<View style={{marginTop: 30}}>
							...
							<View style={styles.viewAlreadyHaveAccount}>
								<Text style={styles.textAlreadyHaveAccount} >Already have an Account?</Text>
							</View>
