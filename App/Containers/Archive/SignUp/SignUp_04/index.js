...
export default class App extends Component{
  ...
  render() {
    ...
    let pic = {
      uri: 'https://antiqueruby.aliansoftware.net//Images/signup/image_bg_signup_four.jpg'
    };
          ...
          <Container style={styles.container}>
            ...
            <View style={styles.view2}>
              <Item underline style={styles.itememail}>
                <Input  placeholderTextColor={Colors.lighttxt} textAlign={I18nManager.isRTL ? 'right' : 'left'} placeholder='Full Name' style={styles.inputemail} />
              </Item>
              <Item underline style={styles.itememail}>
                <Input  placeholderTextColor={Colors.lighttxt} textAlign={I18nManager.isRTL ? 'right' : 'left'} placeholder='Email' style={styles.inputemail} />
              </Item>
              <Item underline style={styles.itememail}>
                <Input  placeholderTextColor={Colors.lighttxt} textAlign={I18nManager.isRTL ? 'right' : 'left'} secureTextEntry={true} placeholder='Password' style={styles.inputpassword} />
              </Item>
              <Item underline style={styles.itememail}>
                <Input  placeholderTextColor={Colors.lighttxt} textAlign={I18nManager.isRTL ? 'right' : 'left'} secureTextEntry={true} placeholder='Confirm Password' style={styles.inputpassword} />
              </Item>
            </View>
