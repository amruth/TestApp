...
import { TouchableHighlight, Dimensions, ImageBackground, Image, View, StatusBar, Platform,BackHandler,I18nManager, TouchableWithoutFeedback, Keyboard ,TouchableOpacity} from 'react-native';
...
export default class App extends Component<{}> {
  ...
  render() {
    ...
    let profileImage = {
      uri: 'https://antiqueruby.aliansoftware.net/Images/signup/profile_pic_suseven.png'
    };
        ...
        <Header style={styles.header}>
          ...
          <Content bounces={false}>
            <View style={styles.pageContent}>
              ...
              <Text style={styles.lightTextStyle}>We’ve sent the confirmation code to your email. Please check your inbox</Text>
              <Text style={styles.textButtonStyle} onPress={this._resendAction}> Resend </Text>
              {/* For Testing */}
              <TouchableHighlight  info>
                <Button style={styles.buttonStyle} onPress={this._onPressSignUp}><Text style={styles.buttonText}>Sign UP</Text></Button>
              </TouchableHighlight>
            </View>
            <View style={styles.footerSec}>
              <Text style={styles.textInputStyle}>Already have an account? </Text>
              <TouchableHighlight  info>
                <Text style={styles.textInputStyle} onPress={this._onPressSignIn}>Sign In</Text>
              </TouchableHighlight>
            </View>
          </Content>
      </ImageBackground>
