...
import { AsyncStorage, Image, StatusBar, View, TouchableOpacity, Linking, Alert,Platform, ListView } from "react-native";
import {Header, Button, Text, Container, List, ListItem, Content, Icon, top, Left, Right,Title,Body} from "native-base";
// Styles
import styles from './styles';

const itemImageOne = "https://antiqueruby.aliansoftware.net//Images/drawer/ic_drawer_item1_dseventeen.png";
const itemImageTwo = "https://antiqueruby.aliansoftware.net//Images/drawer/ic_drawer_item2_dseventeen.png";
const itemImageThree = "https://antiqueruby.aliansoftware.net//Images/drawer/ic_drawer_item3_dseventeen.png";
const itemImageFour = "https://antiqueruby.aliansoftware.net//Images/drawer/ic_drawer_item4_dseventeen.png";
    ...
    return (
      <Container  style={styles.sideBarContainer}>
         ...
         <Header style={styles.headerD}>
           ...
           <View style={styles.bottomViewBg} ></View>
