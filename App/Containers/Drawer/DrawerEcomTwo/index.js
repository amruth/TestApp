...
export default class Drawer_17 extends Component {
  ...
  render(){
		...
		var rightButton = <Button transparent onPress={this._handleBack}>
			<Icon name="ios-create-outline" style={{ color: '#fff', fontSize: 30 }} onPress={this.functionRedirect}/>
		</Button>

		let BG_Image = {
			uri : 'https://antiqueruby.aliansoftware.net/Images/signin/ic_back01_sone.png'
		};
                    ...
                    :
                        <FontAwesome name="angle-left" size={30} color="white"/>
							...
							<Body style={styles.body}>
								<View style={{flexDirection: 'column', marginTop: 10}}>
									...
									<Icon name='ios-arrow-down-outline' style={{color:'white', alignItems:'center', alignSelf: 'center', justifyContent: 'center'}} />
										</TouchableOpacity>
								</View>
						...
						<Modal style={styles.bottomModal} isVisible={this.state.isModalVisible} onBackdropPress={()=>this._hideModal()}>
							...
							<View style={styles.headerbottom}>
								<Text STYLE={{color:'#292d48', textAlign:'center', justifyContent:'center'}}>Filter</Text>
							</View>
							<View style={styles.horizontalline}></View>
								<View style={styles.semirow}>
									 <View style={styles.listrows}>
										<Image source={images.livingroom} style={ styles.rowicon} />
										<Text style={styles.rowtxt}>Living Room</Text>
									 </View>
									 <View style={styles.verticalline}></View>
									 <View style={styles.listrows}>
										<Image source={images.diningroom} style={ styles.rowicon} />
										<Text style={styles.rowtxt}>Dining Room</Text>
									 </View>
									 <View style={styles.verticalline}></View>
									 <View style={styles.listrows}>
										<Image source={images.bookcase} style={ styles.rowicon} />
								...
								<View style={styles.semirow}>
									<View style={styles.listrows}>
									 <Image source={images.bedroom} style={ styles.rowicon} />
									 <Text style={styles.rowtxt}>Bedroom</Text>
									</View>
									 <View style={styles.verticalline}></View>
									<View style={styles.listrows}>
									 <Image source={images.tvstands} style={ styles.rowicon} />
									 <Text style={styles.rowtxt}>TV Stands</Text>
									</View>
									 <View style={styles.verticalline}></View>
									<View style={styles.listrows}>
									 <Image source={images.bathroom} style={ styles.rowicon} />
