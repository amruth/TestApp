...
import { AsyncStorage, Image, StatusBar, View, TouchableOpacity, Linking, Alert,Platform, TextInput, ListView,ScrollView, Modal} from "react-native";
import {Header, Button, Text, Container, List, ListItem, Content, Icon, top, Left, Right,Title, Body, Label, Input} from "native-base";
...
export default class ControlPanel extends Component {
  ...
  onCheckBoxPress(id) {
   ...
   console.warn('selected: ', this.state.SimapleArray)
 }
  ...
  _handleClick(){
    ...
    this.setState({cou : this.state.count + 1})
      ...
      <Container style={styles.mainview}>
        <View style={styles.filterHeader}>
          ...
          <View style={styles.filterIcon}>
            <Ionicons name="ios-options-outline" color={'white'} size={Fonts.moderateScale(18)} />
          </View>
        </View>
            ...
            this.state.SimapleArray.map((item, index) => {
              return(
                <View style={styles.rowMain} key={index}>
                  ...
                  <TouchableOpacity  onPress={() => {this.toggleDeleteModal(true,item.id)}} style={{flexDirection: 'row'}}>
                    <View style={styles.rowVerticalDivider}></View>
        ...
        <View style={styles.bottomView}>
          ...
          <TouchableOpacity onPress={() => {this.toggleModals(true)}} style={styles.addView}>
            <Text style={styles.addText}>Add</Text>
            <MaterialIcons name="add" color={'white'} size={Fonts.moderateScale(22)}/>
          </TouchableOpacity>

          <View style={{flexDirection: 'column', height: Metrics.HEIGHT, width: Metrics.WIDTH}}>
          ...
          <View style={{flexDirection: 'column', height: Metrics.HEIGHT, width: Metrics.WIDTH}}>
            <Modal transparent = {true}
               ...
               onRequestClose = {() => { this.state.modalDeleteVisible(false) } }>
               <View style={styles.modalView}>
                 <View style = {styles.modal}>
                    <Text style={styles.addItemTitle}> Delete Confirmation </Text>


                    <Text style={styles.deleteText}>Are you sure, you want to delete this item?</Text>
          ...
          <View style={styles.profileContainer}>
             ...
             <View style={styles.profileDetail}>
               <View style={styles.profileHeader}>
                 ...
                 <Ionicons name="ios-settings" color={'#6c7084'} size={Fonts.moderateScale(16)}/>
               </View>
