...
import { TouchableHighlight,Dimensions, StyleSheet,ImageBackground,Image,View,StatusBar,Platform , TouchableOpacity, AsyncStorage, I18nManager} from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      <Header style={styles.headerModal}>
         <TouchableOpacity onPress={this.props.closeDrawer} style={{backgroundColor: Colors.transparent,  width: Metrics.WIDTH,paddingLeft: Metrics.WIDTH * 0.06}}>
         {
           (I18nManager.isRTL)
           ?
              <Icon name='md-arrow-round-forward'  style={{color:'white', height: (Metrics.HEIGHT * 0.1), width: (Metrics.HEIGHT * 0.1)}}/>
           :
        ...
        <Content>
          <View style={styles.mainview}>
            <TouchableOpacity onPress={() => this._handlePress('')} style={styles.listrow}>
