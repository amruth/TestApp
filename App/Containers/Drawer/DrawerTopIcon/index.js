...
import { Text, Image, StatusBar,TouchableOpacity, Platform, ImageBackground, BackHandler, ListView, I18nManager} from 'react-native';
...
export default class DrawerTopIcon extends Component {
  ...
  constructor(props){
    ...
    const cardImageOne = "https://antiqueruby.aliansoftware.net//Images/drawer/image_living_room1_dnine.jpg";
    const cardImageTwo = "https://antiqueruby.aliansoftware.net//Images/drawer/image_living_room2_dnine.jpg";
    const cardImageThree = "https://antiqueruby.aliansoftware.net//Images/drawer/image_living_room3_dnine.jpg";
    const cardImageFour = "https://antiqueruby.aliansoftware.net//Images/drawer/image_living_room4_dnine.jpg";
    const cardImageFive = "https://antiqueruby.aliansoftware.net//Images/drawer/image_book_dnine.jpg";
    const cardImageSix = "https://antiqueruby.aliansoftware.net//Images/drawer/image_animal_cat_dnine.jpg";

    const profileImageOne = "https://antiqueruby.aliansoftware.net//Images/drawer/snap_user2_ptwentynine_p28.png";
    const profileImageTwo = "https://antiqueruby.aliansoftware.net//Images/drawer/snap_user3_ptwentynine_p28.png";
    const profileImageThree = "https://antiqueruby.aliansoftware.net//Images/drawer/snap_user4_ptwentynine_p28.png";
  ...
  onTabPress(id) {
   ...
   // alert(id + " pp "+ this.state.selectedLots);

 }

 _renderUpperRow(rowData) {
   return(
     <TouchableOpacity style={styles.upperRowMain} onPress={()=>this.onTabPress(rowData.id)}>
     {
 ...
 _renderLowerRow(rowData) {
   return(
     <View style={styles.lowerRowMain}  animation="zoomIn" duration={1100} delay={200}>
