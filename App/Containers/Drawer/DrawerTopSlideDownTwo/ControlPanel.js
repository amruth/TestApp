        ...
        <ImageBackground source={Images.drawerBG} style={styles.menuimageBg}>
          <View style={styles.menuClose}>
            <TouchableOpacity onPress={() => { this.props.closeDrawer() }}>
              <Ionicons name='ios-close' color='#ffffff' size={65} style={{backgroundColor: 'transparent'}}/>
            </TouchableOpacity>
          </View>
          <View style={styles.menuListSec}>
            <View style={{flexDirection: 'row',}}>
              <View style={[styles.menuList,{ borderBottomWidth: 0.5, borderColor: "#53afe3"}]}>
                <MaterialCommunityIcons name="file-outline" color='#ffffff' size={30} />
                <Text style={styles.menuItemText}>Articles</Text>
              </View>
              <View style={[styles.menuList,{borderLeftWidth: I18nManager.isRTL ? 0 : 0.5, borderRightWidth: I18nManager.isRTL ? 0.5 : 0, borderBottomWidth: 0.5, borderColor: "#53afe3"}]}>
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <View style={[styles.menuList,{borderLeftWidth: I18nManager.isRTL ? 0 : 0.5, borderRightWidth: I18nManager.isRTL ? 0.5 : 0, borderColor: "#53afe3"}]}>
