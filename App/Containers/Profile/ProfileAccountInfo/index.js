...
import { Text,Image, StatusBar, Platform, ImageBackground,TouchableOpacity,View,ListView,BackHandler, I18nManager} from 'react-native';
    ...
    return(
      <Container style={styles.main}>
        ...
        <Image source={{uri:profileImg}} style={styles.profileImg}/>
          ...
          <Text style={styles.descTxt}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis semper non quam sed.</Text>
          <View style={styles.connectWithTwitterBg}>
            <Text style={styles.connectWithTwitterFbTxt}>Connect with Twitter</Text>
          </View>
          <View style={styles.connectWithFacebookBg}>
            <Text style={styles.connectWithTwitterFbTxt}>Connect with Facebook</Text>
          </View>
          ...
          <View style={{flexDirection: 'column'}}>
            <View style={styles.infoFieldBg}>
              ...
              <Text style={styles.infoFieldDetailTxt}>johnie_cornwall@gmail.com</Text>
            </View>
            <View style={styles.fieldDivider}/>
          </View>
          <View style={{flexDirection: 'column'}}>
          ...
          <View style={styles.infoFieldBg}>
            ...
            <Text style={styles.infoFieldDetailTxt}>1201 Westlake Avenue,Suite 205 Seattle, WA 98121 USA</Text>
          </View>
        </Content>
      </Container>
    );
