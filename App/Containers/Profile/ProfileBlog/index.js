...
export default class ProfileBlog extends Component {
  ...
  render(){
    ...
    const bgImage = "https://antiqueruby.aliansoftware.net//Images/profile/home_background_p08.png";
          ...
          <View style={styles.profileDataBg}>
            ...
            <View style={styles.mainview}>
              <View style={styles.personalInfoBg}>
                ...
                <Right>
                  <View style={styles.followBg}><Text style={styles.followTxt}>FOLLOW</Text></View>
                </Right>
              </View>
              ...
              <View style={styles.desc}>
                <ReadMore
                  ...
                  <Text style={styles.descTxt}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis semper non quam sed scelerisque.
                     Vestibulum pharetra dignissim nibh, ut tincidunt magna hendrerit sit amet. Integer sit amet venenatis sem,
                      sit amet ullamcorper nisi. Vivamus dictum facilisis velit, quis commodo magna iaculis sed.
                  </Text>
                </ReadMore>
              </View>
            </View>
