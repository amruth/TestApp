...
const bgImage = "https://antiqueruby.aliansoftware.net//Images/profile/image_bg_profile_nine.jpg";
...
export default class ProfileBlogTwo extends Component {
  ...
  _renderProfileImageRow(rowData){
    return(
      <View>
        <Image style={(rowData.id == '1')?styles.suggestedPeopleImg:styles.suggestedPeopleImgOther} source={rowData.profileImage}/>
      </View>
    )
  }
            ...
            <View style={styles.profileDataBg}>
              ...
              <View style={styles.SuggestedPeopleBg}>
                <View style={styles.suggestConnectionBg}>
                  <Text style={styles.suggestConnectionTxt}>Suggest connections</Text>
