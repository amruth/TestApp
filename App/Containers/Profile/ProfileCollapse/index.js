...
import { Text,Image, StatusBar, ListView, Platform, ImageBackground,Dimensions,TouchableOpacity,View, BackHandler, I18nManager} from 'react-native';
...
const FirendsRoute = () => <View style={[ styles.container, { backgroundColor: 'transparent' } ]}><Tablist/></View>;
  ...
  render(){
    ...
    return(
      ...
      <View style={styles.profileHeaderMain}>
         ...
         <Text style={styles.address}>1201 Westlake Avenue, Suite 205 Seattle, WA 98121 USA</Text>
