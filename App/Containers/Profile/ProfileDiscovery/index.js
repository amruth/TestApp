...
export default class ProfileDiscovery extends Component {
  ...
  render(){
    ...
    const bgImage = "https://antiqueruby.aliansoftware.net//Images/profile/image_bg_profile_seven.png";
    ...
    return(
      <Container style={styles.main}>
        ...
        <LinearGradient locations={[0.6,1]} colors={['transparent','black']} style={styles.gred}>
        <Header
          ...
          <View style={styles.desc}>
            ...
            <View style={styles.address}>
              <Ionicons name="md-pin" color='#0691ce' style={{fontSize: 21}}/>
