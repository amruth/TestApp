...
import { Text, ListView, Image, StatusBar, Platform, ImageBackground,Dimensions,TouchableOpacity, Modal,TouchableHighlight,BackHandler, I18nManager} from 'react-native';
 ...
 *  Profile Screen
 */
const profileBg = "https://antiqueruby.aliansoftware.net//Images/profile/collapse_toolbar_image_ptwo.png";
...
export default class ProfileInterior extends Component {
  ...
  render(){
    ...
    return(
      ...
      <TouchableOpacity style={styles.followTxtBg} onPress={()=>alert('FOLLOW')}><Text style={styles.followTxt}>FOLLOW</Text></TouchableOpacity>
      {/*<View style={styles.dividerHorizontal}></View>*/}
      <ScrollableTabView
        initialPage={0}
