    ...
    return(
      <Container style={styles.main}>
        ...
        <View style={{flexDirection: 'row'}}>
          <View style={styles.followTxtBg}><Text style={styles.followTxt}>FOLLOWING</Text></View>
          <View style={styles.followTxtBgtrans}><Text style={styles.followTxt}>MESSAGE</Text></View>
        </View>
