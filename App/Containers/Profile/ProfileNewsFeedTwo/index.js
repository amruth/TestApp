...
import { Text, Image, StatusBar, Platform, ImageBackground,Dimensions,TouchableOpacity, ListView,FlatList, BackHandler, TouchableHighlight, I18nManager} from 'react-native';
...
export default class ProfileNewsFeedTwo extends Component {
  ...
  _renderLabel = ({route}) => {
    return(
      <View style={styles.tabNameView}>
        <Text style={(route.id == this.state.index)?styles.label:styles.normalLabel}>{route.title}</Text>
        {
          (route.id == 3) ? null : <View style={styles.tabVerticalDivider}></View>
        }
      </View>
    )
  }
          ...
          <View style={styles.rowMainView}>
             <View style={styles.rowBg}>
               ...
               </View>
               {
                 ...
                 <Image style={styles.postDescImage} source={rowData.postImage}></Image>
               }
              <View style={styles.dividerHorizontal}/>
  ...
  render(){
    ...
    const profileBg = "https://antiqueruby.aliansoftware.net//Images/profile/backg_profile_14.png";
      ...
      <View style={styles.imgView}>
        ...
        <View style={styles.contentView}>
          ...
          <View style={styles.profileView}>
            ...
            <Image source={Images.blueCameraIcon} style={styles.cameraIcon}/>
          </View>
