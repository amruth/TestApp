 ...
 *  Profile Screen
 */
const bgImage = "https://antiqueruby.aliansoftware.net//Images/profile/background_p20.png";
...
export default class ProfileOverlay extends Component {
  ...
  _renderFriendsRow(rowData){
    ...
    return(
      <View style={styles.friendView}>
        ...
        <TouchableOpacity style={[styles.socialBg, {backgroundColor: rowData.color}]}>
  ...
  _renderHobbiesRow(rowData){
    return(
      <View style={[styles.hobbiesView, {marginRight: (rowData.id == 6) ? 0 : (Metrics.HEIGHT) * 0.015}]}>
  ...
  render(){
    ...
    return(
      <Container style={styles.main}>
        ...
        <LinearGradient locations={[0.01,0.4,0.6]} colors={['transparent', 'rgba(45, 50, 79, 0.9)', 'black']} style={styles.gradient}>
            ...
            <View style={styles.descView}>
              <ReadMore
                ...
                <Text style={styles.aboutMeDescriptionTxt}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis semper non quam sed scelerisque. Vestibulum pharetra dignissim nibh, ut tincidunt magna hendrerit sit amet. Integer sit amet venenatis sem, sit amet ullamcorper nisi. Vivamus dictum facilisis velit, quis commodo magna iaculis sed.
                </Text>
              </ReadMore>
            </View>
