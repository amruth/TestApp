...
import { Container, Button,Right,Left,ListItem,Content,Body,Icon} from 'native-base';
...
const headerBg = 'https://antiqueruby.aliansoftware.net//Images/profile/backg_top_p05.png';
  ...
  render(){
    ...
    return(
      <Container style={styles.main}>
        <ImageBackground source={{uri:headerBg}} style={styles.titleBarStyle}>

          <TouchableOpacity style={styles.backicon} onPress={()=>this.props.navigation.navigate('Profile')}>
            <Icon name={I18nManager.isRTL ? "ios-arrow-forward" : "ios-arrow-back"} style={styles.backArrow}/>
          </TouchableOpacity>
