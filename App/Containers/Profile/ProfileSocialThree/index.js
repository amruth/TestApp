...
const profileImgTwo = "https://antiqueruby.aliansoftware.net/Images/profile/profile_4_11.png";
           ...
           return (
             ...
             <View style={styles.frdsview}>
              ...
              <View style={styles.frdsinfo}>
                ...
                <Text style={styles.rowDesignationTxt}>{item.designation}</Text>
              </View>
             </View>
