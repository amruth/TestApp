...
import { Text,Image, StatusBar, Platform, ImageBackground,Dimensions,TouchableOpacity,BackHandler, I18nManager,ListView} from 'react-native';
...
const FriendsRoute = () => <View style={[ styles.container, { backgroundColor: 'transparent' } ]}><Tablist/></View>;
const FollowersRoute = () => <View style={[ styles.container, { backgroundColor: 'transparent' } ]}><Tablist/></View>;
const FollowingRoute = () => <View style={[ styles.container, { backgroundColor: 'transparent' } ]}><Tablist/></View>;
const LikesRoute = () => <View style={[ styles.container, { backgroundColor: 'transparent' } ]}><Tablist/></View>;
...
export default class ProfileSocialTwo extends Component {
  ...
  _renderHeader = props => <TabBar
                            ...
                            style={{backgroundColor: "#fff", borderTopLeftRadius:10,borderTopRightRadius:10,elevation:0,borderBottomWidth: 1,borderColor: "#f2f2f2"}} />;
    ...
    return(
      <Container style={styles.mains}>
        <ImageBackground style={styles.imgContainer} source={{uri:bgImage}}>
          <LinearGradient locations={[0.1,1]} colors={['transparent','black']} style={styles.gred}>
          <LinearGradient locations={[0.5,2.5]} colors={['transparent','black']} style={styles.gredTop}>
          <Header
            ...
            <View style={styles.topview}>
              ...
              <View style={styles.followBg}><Text style={styles.followTxt}>FOLLOWING</Text></View>
            </View>
            </LinearGradient>
            <ScrollableTabView
              initialPage={0}
              ...
              style={{width:(Metrics.WIDTH) * 0.95,backgroundColor: 'transparent'}}
