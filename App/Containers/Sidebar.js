...
import { AsyncStorage, Image, StatusBar, View, TouchableOpacity, Linking, Alert,Platform, } from "react-native";
      ...
      <Container>
        <Content style={{backgroundColor: '#1a191f'}}>
                 ...
                 <Header style={styles.header}>
                   ...
                   <View style={{backgroundColor: 'grey', height: 0.3}}></View>
                   <View style={styles.mainview}>
                     ...
                     <TouchableOpacity onPress={() => this._handlePress('Walkthrough')} >
                       <View style={styles.listrow}>
