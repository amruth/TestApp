...
export default class App extends Component<{}> {
  ...
  render() {
    ...
    let pic = {
      uri: 'https://antiqueruby.aliansoftware.net/Images/signin/background_sfourteen.png'
    };
            ...
            <View  style={styles.overlay}>
              ...
              <Form  style={styles.form}>
                <Item rounded style={styles.item}>
                  <Input placeholderTextColor='#929597'  placeholder='john_doe@gmail.com' style={styles.inputemail} />
                </Item>
                <TouchableHighlight  info style={styles.btnget} onPress={() => {}}>
