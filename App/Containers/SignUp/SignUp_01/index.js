...
import { Text, View,Platform, StatusBar,Image,TextInput,TouchableOpacity,ImageBackground,BackHandler,I18nManager } from 'react-native';
...
export default class SignUp_01 extends Component {
    ...
    const imageUri = "https://antiqueruby.aliansoftware.net//Images/signup/ic_signup_bg_s01.png";
				...
				<Container style={styles.container}>
					<ImageBackground style={styles.imgContainer} source={{uri:imageUri}}>
						...
						<Form style={styles.inputLabel}>
							<Item floatingLabel>
								<Label><Text style={styles.textLabel}>Email</Text></Label>
								<Input style={styles.textInput} textAlign={I18nManager.isRTL ? 'right' : 'left'} keyboardType='email-address'></Input>
							</Item>
							<Item floatingLabel>
								<Label><Text style={styles.textLabel}>Password</Text></Label>
								<Input style={styles.textInput} textAlign={I18nManager.isRTL ? 'right' : 'left'} secureTextEntry = {true} keyboardType = "default"></Input>
							</Item>
							<Item floatingLabel>
								<Label><Text style={styles.textLabel}>Confirm Password</Text></Label>
								<Input style={styles.textInput} textAlign={I18nManager.isRTL ? 'right' : 'left'} secureTextEntry = {true} keyboardType = "default"></Input>
							</Item>
						</Form>

						<TouchableOpacity style = {styles.buttonRegister}	onPress = {() => alert('Register Now')}>
							<Text style = {styles.textWhite}>Register now</Text>
						</TouchableOpacity>

						<View style={styles.tandcondi}>
							<Text style={styles.textPolicyDescription}>Clicking register means that you agree to the</Text>
