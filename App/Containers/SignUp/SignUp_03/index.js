...
import { Text,StatusBar,Platform , View, Image,TextInput,TouchableOpacity,ImageBackground, ScrollView,BackHandler,I18nManager} from 'react-native';
...
export default class SignUp_03 extends Component {
    ...
    if(Platform.OS === 'android') {
		...
		const imageUri = "https://antiqueruby.aliansoftware.net//Images/signup/title_pic_s03.png";
		return (
      ...
      <Container style={styles.container}>
              ...
              <TextInput style={styles.textInput}
                ...
                secureTextEntry = {true}
							...
							<TouchableOpacity style = {styles.buttonSignUp}	onPress = {() => alert('Sign Up')}>
