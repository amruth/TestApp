...
export default class Signup_08 extends Component {
  ...
  render(){
		...
		let BG_Image = {
			uri : 'https://antiqueruby.aliansoftware.net//Images/signup/signup_back_08.png'
		};
      ...
      <ImageBackground source={BG_Image} style={styles.mainbg}>
        <Container style={{backgroundColor: 'transparent'}}>
          ...
          <View style={styles.slidesec}>
            ...
            <Text style={styles.desctext}>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</Text>
          </View>

          <View style={styles.btnsec}>
            <View iconRight style={styles.buttonlogin}>
              <FontAwesome name="facebook-f" size={27} color="white"/>
              <Text autoCapitalize = 'words' style={styles.ButtonText}>Sign in with facebook</Text>
            </View>
            <View iconRight style={styles.buttonlogin}>
              <FontAwesome name="twitter" size={27} color="white"/>
              <Text autoCapitalize = 'words' style={styles.ButtonText}>Sign in with twitter</Text>
            </View>
          </View>

          <View style={styles.view3}>
            <Text autoCapitalize="words" style={styles.bottomtext}>Already have an account? Sign In</Text>
          </View>
        </Container>
      </ImageBackground>
    );
