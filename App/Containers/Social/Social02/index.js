...
export default class Social02 extends Component {
  ...
  render(){
    ...
    const profileImageOne = "https://antiqueruby.aliansoftware.net//Images/social/ic_user_one_row_sone.png";
    ...
    const postImageUri = "https://antiqueruby.aliansoftware.net//Images/social/ic_post_social_two.png";
        ...
        data.map((item, index) => {
         return (
           <View style={ (index === data.length - 1) ? styles.lastRowBg : styles.rowBg} key={index}>
             ...
             <View style={[styles.dividerHorizontal, {marginTop: (Metrics.HEIGHT) * 0.015}]}/>
             ...
             <View style={[styles.dividerHorizontal, {marginTop: (Metrics.HEIGHT) * 0.022}]}/>
