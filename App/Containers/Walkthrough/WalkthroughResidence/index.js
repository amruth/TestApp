...
import { Text, View,Dimensions ,Image,TextInput,TouchableOpacity,ImageBackground,StatusBar,Platform,Modal, I18nManager} from 'react-native';
    ...
    if(Platform.OS === 'android') {
      ...
      <Container style={styles.container}>
				...
				<View style={styles.main}>
					<Text style={styles.textGetStarted} onPress = {() => {this.toggleModal(true)}}>Get Started</Text>
				</View>
				...
				<Modal visible = {this.state.modalVisible} transparent={true}
		            ...
		            autoplayTimeout={2.5}
							...
							<TouchableOpacity style={styles.startSliderLayout} onPress={() => alert("Get Started")}>
