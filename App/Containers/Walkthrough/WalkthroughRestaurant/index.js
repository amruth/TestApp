...
export default class WalkthroughRestaurant extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
       data: [
         {
           id: 1,
           image: {uri : 'http://antiqueruby.aliansoftware.net//Images/walkthrough/ic_img01_wtthree.png'},
         ...
         {
           id: 2,
           image: {uri : 'http://antiqueruby.aliansoftware.net//Images/walkthrough/ic_img02_wtthree.png'},
           description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
           next: true,
           prev: false,
         ...
         {
           id: 3,
           image: {uri : 'http://antiqueruby.aliansoftware.net//Images/walkthrough/ic_img03_wtthree.png'},
           description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
           next: true,
           prev: false,
         },
  ...
  render(){
    ...
    var data = [
      {
        id: 1,
        image: {uri : 'https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_img01_wtthree.png'},
        description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        flag: true,
      },
      {
        id: 2,
        image: {uri : 'https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_img02_wtthree.png'},
        description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
      },
      {
        id: 3,
        image: {uri : 'https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_img03_wtthree.png'},
        description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
      },
      {
        id: 4,
